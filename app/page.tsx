        ...
        <div className="max-w-5xl px-4 text-center">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-neutral-400 leading-relaxed">
              Stop wasting months — and burning capital — building products nobody wants. Get <span className="text-blue-400 font-semibold">instant, free feedback</span> on your market, solution, and build complexity.
            </p>
            ...
            >
              <Link href="/validate">
                <Button className="h-14 px-8 text-lg rounded-full shadow-[0_0_20px_rgba(59,130,246,0.5)] hover:shadow-[0_0_30px_rgba(59,130,246,0.6)] transition-all duration-300">
                  Validate my MVP
                </Button>
              </Link>
